...
void Lab2::Init()
{
    ...
    // by definition!
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(3, 2, 3), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 3, 3), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-1, 1.5f, 0), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(1, -1.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(0, 3.f, 0));
