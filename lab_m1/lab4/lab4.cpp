...
void Lab4::RenderScene() {
    ...
    modelMatrix *= transform3D::RotateOY(angularStepOY2);
    // translatie in origine, rotatie, translatie inapoi

    modelMatrix *= transform3D::Translate(2.5f, 0.5f, 0.0f); // pozitie finala
